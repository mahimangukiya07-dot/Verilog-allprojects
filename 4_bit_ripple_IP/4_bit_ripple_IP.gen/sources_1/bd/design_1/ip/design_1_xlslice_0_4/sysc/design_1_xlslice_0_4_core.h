...
#ifndef _design_1_xlslice_0_4_core_h_
#define _design_1_xlslice_0_4_core_h_

#include <systemc.h>
#include "properties.h"


class design_1_xlslice_0_4_core : public sc_module 
{
    public: 
       design_1_xlslice_0_4_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , Din    ( "Din" )
              , Dout   ( "Dout" )
    {
        SC_HAS_PROCESS(design_1_xlslice_0_4_core);
        SC_METHOD(get_slice_value);
        sensitive << Din;

    }

    virtual ~design_1_xlslice_0_4_core() = default;
